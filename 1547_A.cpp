...
int32_t main()
{
	...
	for (int t = 1; t <= tt; t++){
		...
		int val = abs(v[1][0] - v[0][0]) + abs(v[1][1] - v[0][1]);
		if ((v[0][0] == v[1][0] and v[2][0] == v[0][0] and (v[2][1] > min(v[0][1] , v[1][1]) and v[2][1] < max(v[0][1] , v[1][1]))) || (v[0][1] == v[1][1] and v[2][1] == v[0][1] and (v[2][0] > min(v[0][0]  , v[1][0]) and v[2][0] < max(v[0][0] , v[1][0])))) val += 2;
